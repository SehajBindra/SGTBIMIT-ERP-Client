  ...
  return (
    <div className=" flex flex-row h-[530px] my-20 max-w-5xl mx-auto ">
      ...
      <div className="bg-white text-left flex  ml-16 flex-col my-8">
        ...
        <div
          className="flex  border  border-[##D9D9D9] text-center flex-row items-center mt-8 px-10  
          bg-[#EEEE] max-w-sm  space-x-8 capitalize text-[16px] rounded-[32px]"
        >
          <p className=" text-[#1B449C] font-semibold">student</p>
          <p className="text-white rounded-[32px] h-12 text-center max-w-xs w-full bg-[#1B449C] ">
            faculty
          </p>
        </div>
