              ...
              <div>
                ...
                <div className="mt-2">
                  <input
                    ...
                    required
                    className="block w-[440px] rounded-md border-0 py-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#1B449C] sm:text-sm sm:leading-6"
                  />
                </div>
