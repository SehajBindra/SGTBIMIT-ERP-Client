  ...
  return (
    <div className=" grid grid-cols-4 h-[530px] my-16 mx-auto max-w-7xl ">
      ...
      <div className="bg-white text-left  col-span-2 my-8">
        ...
        <p className="text-black/60 text-[14px] my-4">
          Welcome to the ERP system of SGTBIMIT
        </p>

        <div
          className="flex  flex-row items-center  justify-center h-16 text-[#
            ...
            <form className="space-y-6" action="#" method="POST">
              ...
              <div>
                <div className="flex items-center justify-between">
                  <label
                    htmlFor="password"
                    className="block  font-normal leading-6 text-black/60"
                  >
                    Password
                  </label>
