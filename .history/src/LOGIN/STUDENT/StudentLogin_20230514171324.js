  ...
  return (
    <div className=" flex flex-row h-[530px] my-20 max-w-5xl mx-auto ">
      ...
      <div className="bg-white text-left flex  ml-16 flex-col my-8">
        ...
        <div
          className="flex   border-[##D9D9D9] flex-row items-center mt-8  justify-center h-10 
          bg-[#EEEE] max-w-xs  space-x-16 capitalize text-[16px] rounded-[32px]"
        >
          <p className=" text-[#1B449C] font-semibold">student</p>
          <p className="text-white bg-[#1B449C] h-[24px] w-[70px] rounded-[32px]">
            faculty
          </p>
        </div>
