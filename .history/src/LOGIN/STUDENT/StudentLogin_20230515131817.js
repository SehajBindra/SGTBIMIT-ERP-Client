...
const StudentLogin = () => {
  ...
  return (
    <div className=" flex flex-row  my-20 max-w-7xl mx-auto ">
      <div className=" bg-black w-full hidden md:inline-flex flex-col   ">
        <img
        ...
        />
        <img
          className="hidden w-[500px]  md:inline h-[530px] object-cover rounded-xl"
          src="/sgtb.jpg"
          alt="banner_image"
        />
      </div>

      <div className="bg-white w-full text-left flex  ml-16 flex-col my-8">
