...
const StudentLogin = () => {
  ...
  return (
    <div className=" flex flex-row  my-20 max-w-7xl mx-auto ">
      <div className=" flex-1 justify-center align-middle  hidden md:inline-flex flex-col   ">
        {/* <img
        ...
        /> */}
        <img
          className="hidden   md:inline h-auto object-cover rounded-xl"
          src="/sgtb.jpg"
          alt="banner_image"
        />
      </div>

      <div className="bg-white flex-auto  text-left flex  ml-16 flex-col my-8">
