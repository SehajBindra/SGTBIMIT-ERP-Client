...
const StudentLogin = () => {
  ...
  return (
    <div className=" flex flex-row h-[530px]  max-w-5xl mx-auto ">
      ...
      <div className="bg-white text-left flex  ml-16 flex-col my-8">
        ...
        <div
          className="flex  flex-row items-center mt-8  justify-center h-10 text-[#
          ...
          <div className="mt-10 text-[16px] capitalize  sm:w-full sm:max-w-sm">
            <form className="space-y-6" action="#" method="POST">
              ...
              <div>
                <button
                  type="submit"
                  className="flex w-40 justify-center rounded-md bg-[#1B449C] px-3 py-2.5 text-[16px] font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Login
                </button>
              </div>
