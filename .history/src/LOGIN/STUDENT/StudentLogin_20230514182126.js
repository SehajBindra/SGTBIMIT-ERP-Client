  ...
  return (
    <div className=" flex flex-row h-[530px] my-20 max-w-5xl mx-auto ">
      ...
      <div className="bg-white text-left flex  ml-16 flex-col my-8">
        ...
        <div className="bg-[#EEEEEE] rounded-[32px] max-w-sm">
          <button
            className={`rounded-full "bg-[##EEEEEE]" w-32 h-12 ${
              isBlue ? "bg-blue-500 text-white" : "bg-[#EEEEEE]"
            }`}
            onClick={handleClick}
          >
            Student
